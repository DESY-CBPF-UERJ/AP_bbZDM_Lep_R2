...
void HEPHero::SetupPhiCheck() {
    ...
    //_outputTree->Branch("variable1NameInTheTree", &PhiCheck::variable1Name );  [example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::PhiCheckSelection() {
    ...
    //PhiCheck::variable1Name = 100;      [Example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::PhiCheckSystematic() {
