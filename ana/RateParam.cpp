...
void HEPHero::SetupRateParam() {
    ...
    sys_regions = { 0, 1, 2, 3, 4, 5, 6, 7 }; // Use the same IDs produced by the Regions() function. Empty vector means that all events will be used.
    makeSysHist( "MET_pt", 400, 0., 2000., "MET [GeV]", "Number of events");
    makeSysHist( "MLP4_score", 100, 0., 1., "MLP4_score", "Number of events");

    //======SETUP OUTPUT BRANCHES==================================================================
    //_outputTree->Branch("variable1NameInTheTree", &RateParam::variable1Name );  [example]

    //======SETUP INFORMATION IN OUTPUT HDF5 FILE==================================================
    //HDF_insert("variable1NameInTheTree", &RateParam::variable1Name );  [example]
...
bool HEPHero::RateParamRegion() {
    ...
    Regions();
    if( !((RegionID >= 0) && (RegionID <= 7)) ) return false;                   // 0=SR, 1=DY-CR, 2=ttbar-CR, 3=WZ-CR, 4=ZZ-CR
...
//-------------------------------------------------------------------------------------------------
void HEPHero::RateParamSelection() {
    ...
    //RateParam::variable1Name = 100;      [Example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::RateParamSystematic() {
