...
void HEPHero::SetupWptWgtSRCR() {
    ...
    //_outputTree->Branch("variable1NameInTheTree", &WptWgtSRCR::variable1Name );  [example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::WptWgtSRCRSelection() {
    ...
    //WptWgtSRCR::variable1Name = 100;      [Example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::WptWgtSRCRSystematic() {
