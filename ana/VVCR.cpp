...
void HEPHero::SetupVVCR() {
    ...
    HDF_insert( "Trigger", &VVCR::Trigger );
...
//-------------------------------------------------------------------------------------------------
bool HEPHero::VVCRRegion() {


    LeptonSelection();
    
    if( !((RecoLepID >= 30000) && (RecoLepID <= 49999))  ) return false;                                        // Has two reconstructed leptons with opposite signal
...
//-------------------------------------------------------------------------------------------------
void HEPHero::VVCRSelection() {
    


    //======ASSIGN VALUES TO THE OUTPUT VARIABLES==================================================
    //VVCR::variable1Name = 100;      [Example]
