...
void HEPHero::SetupZZ16() {
    ...
    //_outputTree->Branch("variable1NameInTheTree", &ZZ16::variable1Name );  [example]
...
//-------------------------------------------------------------------------------------------------
bool HEPHero::ZZ16Region() {

    LeptonSelection();
    
    if( !(Nleptons == 4) ) return false;                                        // Has two reconstructed leptons with opposite signal
...
void HEPHero::ZZ16Selection() {
    ...
    //ZZ16::variable1Name = 100;      [Example]
