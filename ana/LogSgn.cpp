...
void HEPHero::SetupLogSgn() {
    ...
    //_outputTree->Branch("variable1NameInTheTree", &LogSgn::variable1Name );  [example]
    ...
    HDF_insert( "Log_MLP_score", &LogSgn::Log_MLP_score_torch );
...
//-------------------------------------------------------------------------------------------------
void HEPHero::LogSgnSelection() {




    //LogSgn::Log_MLP_score_torch = log
    ...
    //LogSgn::variable1Name = 100;      [Example]
