...
//-------------------------------------------------------------------------------------------------
void HEPHero::effMapsV9Selection() {

    // Only selected jets
    for (unsigned int ijet = 0; ijet < nJet; ++ijet) {
        cout << "here" << ijet << nJet << endl;
        if (
...
//-------------------------------------------------------------------------------------------------
void HEPHero::effMapsV9Systematic() {
