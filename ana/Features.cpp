...
void HEPHero::SetupFeatures() {
    ...
    //_outputTree->Branch("variable1NameInTheTree", &Features::variable1Name );  [example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::FeaturesSelection() {
    
    


    //cout << "rate " << evtWeight/evtWeight_before << endl;
    ...
    //Features::variable1Name = 100;      [Example]
...
//-------------------------------------------------------------------------------------------------
void HEPHero::FeaturesSystematic() {
